...
load /Users/richardprather/Dropbox/Rich/PratherLab/Tasks/Estimation/eststim.mat %saved trials as matlab data file
% tbterpstim.mat
...
trialnames = cell(60,2);
load /Users/richardprather/Dropbox/Rich/PratherLab/Tasks/DotComparison/trialnames.mat

for d=1:64 %for each set of comparison stims, currently at 1:40 for all x:x for X
...
tnum = num2str(d);
tvalue = num2str(trials(d,1));
triallabel = strcat('trial',tnum,'_',tvalue);
...
print(gcf,'-dpng','-r300',triallabel);
